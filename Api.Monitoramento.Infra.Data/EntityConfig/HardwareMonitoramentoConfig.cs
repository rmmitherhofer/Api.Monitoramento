...
{
    internal class HardwareMonitoramentoConfig : IEntityTypeConfiguration<HardwareMonitoramento>
    {
        public void Configure(EntityTypeBuilder<HardwareMonitoramento> builder)
        {
            ...
            builder.Property(h => h.Atualizado).HasColumnType("BIT").IsRequired();
            builder.Ignore(h => h.ValidationResult);
        }
    }
}
